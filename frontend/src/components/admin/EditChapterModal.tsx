...
export default function EditChapterModal({ isOpen, onClose, onSuccess, subjectId, chapter }: EditChapterModalProps) {
    ...
    const handleSubmit = async () => {
        if (!formData.title || !subjectId || !chapter?.id) return;

        setIsSubmitting(true);
        try {
            await api.put(`/exams/subjects/${subjectId}/chapters/${chapter.id}`, formData);
            onSuccess();
            onClose();
        } catch (error) {
